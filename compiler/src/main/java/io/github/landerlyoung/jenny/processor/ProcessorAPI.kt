...
interface ProcessorAPI<T> {
    /**
     * Processes the given input for Glue generation.
     * @param input the input object to be processed for Glue.
     */
    ...
    /**
     * Processes the given input for Proxy generation.
     * @param input the input object to be processed for Proxy.
     */
     ...
     */
    fun setProxyConfiguration(configuration: JennyProxyConfiguration)
